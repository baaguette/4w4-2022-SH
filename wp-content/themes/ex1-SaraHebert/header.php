...
<header class="site__header">
    ...
    <section class="util">
        ...
        <!-- a[href="#"].icone__lien*5 -->
            ...
            <svg width="32px" height="32px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" color="#ffffff">
        ...
        <form action="" class="recherche">
            ...
            <svg width="45px" height="45px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" color="#000000">
...
<section class="site__barre">
    ...
    <svg width="36px" height="36px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" color="#000000"><path fill-rule="evenodd" d="M3 7a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 6a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
    </label>
    <?php wp_nav_menu(); ?>
</section>