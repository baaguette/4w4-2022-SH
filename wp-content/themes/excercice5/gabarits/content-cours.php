...
<article class="formation__cours  <?php  echo $categorie[1]->slug; ?>">
   ...
   //echo $nombre_dheure;
    ...
    $descCours = wp_trim_words(get_the_content(),15, "<button class='cours__desc__ouvrir>Ouvrir</button>'");
    ?>
    ...
    <p class="cours__desc"> 
        <?= wp_trim_words($descCours,12,"<button class='cours__desc__ouvrir'>Suite</button>"); ?></p>
</article>