...
if( ! defined( 'WPNW_VERSION' ) ) {
	define( 'WPNW_VERSION', '4.5.6' ); // Version of plugin
}
...
if( ! defined( 'WPNW_PLUGIN_LINK_WELCOME' ) ) {
	define('WPNW_PLUGIN_LINK_WELCOME','https://www.essentialplugin.com/wordpress-plugin/sp-news-and-scrolling-widgets/?utm_source=WP&utm_medium=News&utm_campaign=Welcome-Screen#wpos-epb'); // Plugin Check link
}
